...
public class Application {
    ...
    //need protected and final
    protected static final int TOTAL_MILES = 800;
    protected static final int MILES_PER_DAY = 15;
    protected static final int FOOD_EXCHANGE = 2;
    protected static final int MAX_DAYS = 87;
    protected static final int WAGON_SIZE = 8;
    protected static final int NUM_TRAVELERS = 2;
    protected static final int NUM_CARPENTERS = 3;
    protected static final int NUM_RANGERS = 3;
