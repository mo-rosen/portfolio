...
public class RangerTest {
    ...
    void canExecuteSpecializedMethodTwo() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method forageMedicine = CLASS.getMethod(SPECIALIZED_METHOD_MEDICINE, Traveler.class);
        forageMedicine.invoke(this.subclassInstance, TestUtil.getDefaultTestTraveler("Billy"));
    }
